...
export default function Navbar() {
    ...
    return (
        ...
        >
            <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4 md:gap-6">
                <Link
                    href={home()}
                    className="flex shrink-0 items-center text-tblack"
                    onClick={closeMobile}
                >
                    <img
                        src="/assets/logo.png"
                ...
                <div className="ml-auto- flex md:hidden">
                    <button
                        ...
                        aria-label={t('nav.mobileOpenMenuAria')}
