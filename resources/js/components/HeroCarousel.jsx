...
export function shouldShowHeroCarousel(pathname) {
    ...
    if (/^\/experts\/[^/]+/.test(path)) {
        if (path === '/experts/become' || path === '/experts/connect') {
...
function HomeHeroCarousel({ locale }) {
    ...
    return (
        <div
            className="relative mx-auto w-full max-w-[min(100%,1920px)] px-3 py-8 sm:px-5 sm:py-10 lg:px-10"
        ...
        >
            <div
                ...
                className="relative min-h-[min(28rem,72vh)] max-h-[42rem] overflow-hidden rounded-3xl border border-border shadow-[0_24px_60px_-12px_rgba(15,23,42,0.18)] ring-1 ring-tblack/10"
            >
...
export default function HeroCarousel() {
    ...
    return (
        <section className="relative bg-background" aria-label="Page hero">
            <div className="relative mx-auto w-full max-w-[min(100%,1920px)] px-3 py-8 sm:px-5 sm:py-10 lg:px-10">
