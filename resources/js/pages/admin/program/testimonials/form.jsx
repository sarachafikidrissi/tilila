    ...
    return (
        <AppLayout>
            ...
            <form onSubmit={submit} className="mx-auto max-w-2xl space-y-4 p-6">
                <h1 className="text-2xl font-bold">{isEdit ? 'Edit' : 'New'} testimonial</h1>
                <div>
                    <Label>Program</Label>
                    <select className="w-full rounded-md border px-3 py-2" value={data.program} onChange={(e) => setData('program', e.target.value)}>
                ...
                <div>
                    ...
                    <textarea className="w-full rounded-md border px-3 py-2" rows={3} value={data.quote.fr} onChange={(e) => setData('quote', { ...data.quote, fr: e.target.value })} />
                </div>
                <div>
                    <Label>Role (FR)</Label>
                    <Input value={data.role.fr} onChange={(e) => setData('role', { ...data.role, fr: e.target.value })} />
                </div>
                <div>
                    <Label>Photo</Label>
